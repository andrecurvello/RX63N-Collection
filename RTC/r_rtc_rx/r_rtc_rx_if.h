...
#define RTC_RX_VERSION_MINOR        (50)
...
typedef enum e_rtc_output
{
    ...
    RTC_OUTPUT_64_HZ,           // RX11x, RX130, RX23x, RX64M, RX65N, RX71M
#endif
    RTC_OUTPUT_END_ENUM
} rtc_output_t;
...
typedef enum
{
    ...
    RTC_CMD_PARTIAL_RESET,          // primarily output clock, alarms and capture regs
#if !defined(BSP_MCU_RX11_ALL) && !defined(BSP_MCU_RX130)
    RTC_CMD_CONFIG_CAPTURE,         // configure capture pin; RX210, RX230, RX231, RX63N/RX631, RX64M, RX65N, RX71M
...
typedef enum
{
    ...
    RTC_ERR_MISSING_CALLBACK,  // No callback func and Periodic or Alarm INTs requested
