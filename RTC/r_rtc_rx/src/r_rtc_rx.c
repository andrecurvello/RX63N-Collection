...
*                An argument pointer may be NULL/not specified if the corresponding time is not desired.
* Arguments    : p_current
...
*                The subclock is not stopped in case it is in use by another module.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void R_RTC_Close(void)
{
    ...
    /* Do NOT stop Subclock in case needed by application */
...
***********************************************************************************************************************/
uint8_t rtc_bcd_to_dec (uint8_t to_convert)
{
