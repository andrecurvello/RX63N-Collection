...
#define RTC_INT_ENABLE          (0x05)  /* Enable the AIE bit and the PIE bit. */
    ...
    #error "ERROR - Only one drive capacity #define may be uncommented in r_rtc_rx_config.h"
        ...
        #define RTC_DRIVE_CAPACITY      (2 << 1)
    #elif defined(RTC_CFG_DRIVE_CAPACITY_MD)
        #define RTC_DRIVE_CAPACITY      (0 << 1)
    #elif defined(RTC_CFG_DRIVE_CAPACITY_HI)
        #define RTC_DRIVE_CAPACITY      (1 << 1)
    #elif defined(RTC_CFG_DRIVE_CAPACITY_STD)
        #define RTC_DRIVE_CAPACITY      (4 << 1)
    #endif
#else /* RX130, RX210, RX230, RX231, RX63N/631, RX64M, RX65N, RX71M */
    #if defined(RTC_CFG_DRIVE_CAPACITY_LO)
        #define RTC_DRIVE_CAPACITY      (1 << 1)
    #elif defined(RTC_CFG_DRIVE_CAPACITY_STD)
        #define RTC_DRIVE_CAPACITY      (6 << 1)
    #elif defined(RTC_CFG_DRIVE_CAPACITY_MD)
